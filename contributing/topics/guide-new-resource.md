...
func (r ResourceGroupExampleResource) Create() sdk.ResourceFunc {
    return sdk.ResourceFunc{
        ...
        Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
            ...
            // unless the user has opted into doing so by setting the `skip_existence_check_and_allow_overwrite` flag
            ...
            // the Resource ID before polling the asynchronous operation for completion using the `save_state_before_polling` feature.
