...
func (r OrchestratedVirtualMachineScaleSetResource) skuProfile(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    resource_group {
...
func (r OrchestratedVirtualMachineScaleSetResource) priorityMixPolicy(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    resource_group {
