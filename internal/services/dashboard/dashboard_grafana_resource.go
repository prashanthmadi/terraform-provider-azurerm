...
type DashboardGrafanaModel struct {
	...
	AutoGeneratedDomainNameLabelScope managedgrafanas.AutoGeneratedDomainNameLabelScope `tfschema:"auto_generated_domain_name_label_scope"`
...
func (r DashboardGrafanaResource) IDValidationFunc() pluginsdk.SchemaValidateFunc {
	return managedgrafanas.ValidateGrafanaID
}
...
func expandSMTPConfigurationModel(input []SMTPConfigurationModel) *managedgrafanas.GrafanaConfigurations {
	if len(input) == 0 {
		return nil
	}

	v := input[0]
	smtp := managedgrafanas.Smtp{
		...
		StartTLSPolicy: (*managedgrafanas.StartTLSPolicy)(pointer.To(v.StartTLSPolicy)),
	}
...
func expandGrafanaIntegrationsModel(inputList []AzureMonitorWorkspaceIntegrationModel) *managedgrafanas.GrafanaIntegrations {
	...
	return &managedgrafanas.GrafanaIntegrations{
		AzureMonitorWorkspaceIntegrations: expandAzureMonitorWorkspaceIntegrationModelArray(inputList),
	}
}

func expandAzureMonitorWorkspaceIntegrationModelArray(inputList []AzureMonitorWorkspaceIntegrationModel) *[]managedgrafanas.AzureMonitorWorkspaceIntegration {
	outputList := make([]managedgrafanas.AzureMonitorWorkspaceIntegration, 0, len(inputList))
	for _, v := range inputList {
		input := v
		output := managedgrafanas.AzureMonitorWorkspaceIntegration{
...
func flattenAzureMonitorWorkspaceIntegrationModelArray(inputList *[]managedgrafanas.AzureMonitorWorkspaceIntegration) []AzureMonitorWorkspaceIntegrationModel {
	if inputList == nil {
